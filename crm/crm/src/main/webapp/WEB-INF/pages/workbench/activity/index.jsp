...
<script type="text/javascript">
	...
	$(function(){
		...
		//这种方式不合适，因为checkbox是动态生成的，所以可能还没有生成
	...
	function queryActivityByConditionForPage(no,size) {
		...
		$.ajax({
			...
			success: function (data){
				...
				$.each(data.activityList,function(index, obj){
					...
					htmlString += "<td><a style=\"text-decoration: none; cursor: pointer;\" onclick=\"window.location.href='detail.html';\">" + obj.name + "</a></td>"
				...
				$("#checkall").prop("checked",false)
				var totalPages=1
				if(data.totalRows%size==0){
					totalPages=data.totalRows/size
				}else{
					totalPages=parseInt(data.totalRows/size)+1
				}
...
<%--				<div>--%>
<%--					<button type="button" class="btn btn-default" style="cursor: default;">共<b id="totalRowsB">10</b>条记录</button>--%>
<%--				</div>--%>
